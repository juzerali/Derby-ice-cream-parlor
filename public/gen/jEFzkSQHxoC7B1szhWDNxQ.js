...
view._makeAll(
{
  ...
  "app/bid.html:body": "<h1>Welcome {{_user._id}}!</h1><p>Your current bid is {_user.bid}! </p><br><form x-bind=\"submit: bid\" method=\"GET\" ><input type='number' id='bidvalue' min='1' step='1' value='{{_user.bid}}' max='9999999999'><input type='submit' value='Bid' ></form>"
}, {
  "title": [

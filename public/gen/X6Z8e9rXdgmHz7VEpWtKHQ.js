...
view._makeAll(
{
  ...
  "app/bid.html:body": "<h1>Welcome {{_user.name}}!</h1><p>Your current bid is {_user.bid}! </p><br><form x-bind='submit:bid'><input type='number' id='bidvalue' min='1' step='1' value='{{_user.bid}}' pattern='[0-9]{1,}' max='9999999999'><input type='submit' value='Bid' ></form>"
}, {
  "title": [

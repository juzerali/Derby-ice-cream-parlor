...
view._makeAll(
{
  ...
  "app/bid.html:body": "<h3>Bid unique and minimum to win</h3>{{#with bid}}<h1>Welcome {{users.username.name}}!</h1><p>Your current bid is {users.username.bid}! </p><br><form x-bind='submit:bid'><input type='number' id='bid' min='1' step='1' value='{users.username.bid}' pattern='[0-9]{1,}' max='9999999999'><input type='submit' value='Bid' ></form>",
  "app/home.html:body": "<img src=''/><form method=\"POST\" action=\"!#gotopage\"><input type='text' name='username'/><input type='submit' value='Go to your page'></form>"
}, {
  "title": [

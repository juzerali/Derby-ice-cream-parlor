...
view._makeAll(
{
  ...
  "app/bid.html:body": "<h1>Welcome {{_user.id}}!</h1><p>Your current bid is {_user.bid}! </p><br><input type='number' id='bidvalue' min='1' step='1' value='{_user.bid}' max='9999999999'>"
}, {
  "title": [

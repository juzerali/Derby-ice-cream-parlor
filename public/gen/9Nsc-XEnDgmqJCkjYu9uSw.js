...
view._makeAll(
{
  ...
  "app/index.html:header": "<body> <h1>Bid unique and minimum to win this ice-cream</h1><h2><app:shared:pointer></h2><app:shared:alert>",
  "app/shared.html:pointer": "<div>This auction ending at {_auction.0.ending} </div><div>Current Winner {_auction.0.winner}</div><div>Last run: {_auction.0.ended}</div>",
  ...
  "app/bid.html:body": "<h1>Welcome {{_user.id}}!</h1><p>Your current bid is {_user.bid}! </p><br><input type='number' id='bidvalue' min='1' step='1' value='{_user.bid}' max='9999999999'><input type='submit' value='Bid' >"
}, {
  "title": [
